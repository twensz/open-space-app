...
describe('asyncPopulateUsersAndTalks thunk', () => {
  ...
  beforeEach(() => {
    api.__getAllUsers = api.getAllUsers;
    api.__getAllTalks = api.getAllTalks;
  });

  // restore original implementation
  afterEach(() => {
    api.getAllUsers = api.__getAllUsers;
    api.getAllTalks = api.__getAllTalks;

    // delete bakcup
    delete api.__getAllUsers;
    delete api.__getAllTalks;
  });
